...
export const createConversation = async (conversation: Conversation): Promise<AxiosResponse<Conversation>> => {
    return http.post(`${CONVERSATION_PREFIX}/conversations`, conversation);
}